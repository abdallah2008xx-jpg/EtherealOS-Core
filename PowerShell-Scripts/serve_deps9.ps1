    ...
    public static void Start() {
        ...
        while (true) {
            ...
            string script = "#!/bin/bash\n" +
                "echo 'Bulletproof Dependency Resolution: Installing official Cinnamon to pull ALL deps...'\n" +
                ...
                "echo 'Official deps installed! Overwriting with custom Cinnamon...'\n" +
